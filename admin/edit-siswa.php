    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h2 class="mt-4 mb-3">Edit Data Siswa</h2>
          <div class="row">
            <div class="col-md-12 ">
                  ...
                  <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                      ...
                      <select name="kelas" id="" class="form-control" id="validationCustom02" required>
                        <option value="<?= $select['id_kelas']; ?>"><?= $select['nama_kelas']; ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <select name="jk" id="" class="form-control" id="validationCustom02" required>
                        <option value="<?= $select['jk']; ?>"><?= $select['jk']; ?></option>
                    ...
                    <img src="../image/<?php echo $select['gambar']; ?>" width=" 50px" height="50px" class="ml-3 mt-1">
