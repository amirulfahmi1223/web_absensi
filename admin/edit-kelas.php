    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h2 class="mt-4 mb-3">Tambah Data Kelas</h2>
          <div class="row">
            <div class="col-md-12 ">
              <div class="card shadow-lg mb-5">
                <div class="card-body">
                  <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <img src="logo/<?php echo $select['logo']; ?>" width=" 50px" height="50px" class="ml-3 mt-1">
                    ...
                    <button type="submit" name="ubah" class="btn btn-info mt-1 mb-1 float-right text-white" name="submit">Ubah</button>
                  </form>
                </div>
              </div>
            </div>
